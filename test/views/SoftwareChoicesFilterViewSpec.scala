...
class SoftwareChoicesFilterViewSpec extends ViewBaseSpec with SoftwareProvidersTestConstants {
  ...
  object Selectors {
    ...
    val suitableForFilterHeader = "#searchForm > div > div.govuk-grid-column-one-third > div:nth-child(1) legend"
    val agentFilter = """label[for="AGENT"]"""
    val businessFilter = """label[for="BUSINESS"]"""
    val softwareForFilterHeader = "#searchForm > div > div.govuk-grid-column-one-third > div:nth-child(2) legend"
    ...
    val softwareFeaturesFilterHeader = "#searchForm > div > div.govuk-grid-column-one-third > div:nth-child(3) legend"
    val accountingFilter = """label[for="ACCOUNTING"]"""
    val spreadsheetsFilter = """label[for="SPREADSHEETS"]"""
    val priceFilterHeader = "#searchForm > div > div.govuk-grid-column-one-third > div:nth-child(4) legend"
    val freeFilter = """label[for="FREE"]"""
    val softwareLanguageFilterHeader = "#searchForm > div > div.govuk-grid-column-one-third > div:nth-child(5) legend"
    val welshFilter = """label[for="WELSH"]"""
    val accessibilityFeaturesFilterHeader = "#searchForm > div > div.govuk-grid-column-one-third > div:nth-child(6) legend"
